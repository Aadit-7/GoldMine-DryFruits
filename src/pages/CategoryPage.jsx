  ...
  return (
    <main className="mx-auto max-w-[1200px] px-4 py-8">
      ...
      <nav className="mb-6 flex items-center gap-2 text-sm text-text-soft">
        ...
        <span className="font-medium text-text-ink">{categoryName}</span>
      </nav>
      ...
      <div className="mb-8">
        ...
        <p className="max-w-2xl text-text-soft">
          Discover our premium selection of naturally sourced products.
          Carefully selected for exceptional taste and quality.
        </p>
      </div>
